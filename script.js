...
document.getElementById('game').addEventListener('keydown', ev => {
    ...
    if(isLetter){
        if(currentLetter){
            ...
            const incocrrectLetter = document.createElement('span');
            incocrrectLetter.innerHTML = key;
            incocrrectLetter.className = 'letter incorrect extra';
            currentWord.appendChild(incocrrectLetter);
        }
    }
